...
public class XboxController extends Controller {
  public final Joystick leftStick =
      new Joystick(this.axis(0).withDeadzone(0.1), this.axis(1).invert().withDeadzone(0.1));
  public final Joystick rightStick =
      new Joystick(this.axis(4).withDeadzone(0.1), this.axis(5).invert().withDeadzone(0.1));
